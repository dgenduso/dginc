...
const levels = [
  {
    ...
    body: "The frameworks and processes that define how organizations learn, build, and evolve. Not a methodology you follow once — a system you install and run continuously. This is the layer everything else runs on.",
  ...
  },
  {
    ...
    body: "Capabilities are enablement — the things an organization can do because the operating system is in place. The ability to learn from customers. To work across functions as one. To run an innovation process. To ship and improve continuously. You build them, add to them, and improve them over time.",
